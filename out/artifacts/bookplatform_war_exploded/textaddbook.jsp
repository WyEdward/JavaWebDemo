...
<div class="main">
    <div class="login w">
        <span>欢迎来到填写书资料页面</span>
        <form method="post" action="addBookServlet">
            <p>
                <label for="book_name">书名&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</label>
                <input type="text" name="book_name" id="book_name"required>
            </p>
            <p>
                <label for="book_writer">书的作者&nbsp</label>
                <input type="text" name="book_writer" id="book_writer"required>
            </p>
            <p>
                <label for="book_press">出版社&nbsp&nbsp&nbsp&nbsp&nbsp</label>
                <input type="text" name="book_press" id="book_press"required>
            </p>
            <p>
                <label for="book_remakes">捐赠备注&nbsp&nbsp</label>
                <input type="text" name="book_remakes" id="book_remakes">
            </p>
