...
<div class="main">
    <div class="login w">
        <span>欢迎来到用户注册页面</span>
        <form method="post" action="addUserServlet">
            <p>
                <label for="nick">昵称&nbsp&nbsp&nbsp&nbsp&nbsp</label>
                <input type="text" name="user_nick" id="nick"required>
            </p>
            <p>
                <label for="iphone">电话&nbsp&nbsp&nbsp&nbsp&nbsp</label>
                <input type="text" name="user_phone" id="iphone" required>
            </p>
            <p>
                <label for="password">密码&nbsp&nbsp&nbsp&nbsp&nbsp</label>
